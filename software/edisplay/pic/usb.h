...
// Definitions from "Device Class Definition for Human Interface Devices (VENDOR)",
// version 1.11
//

// Class Descriptor Types
#define VENDOR_DESCRIPTOR   0x21
#define REPORT_DESCRIPTOR   0x22
#define PHYSICAL_DESCRIPTOR 0x23

// VENDOR Class specific requests
...
#define BDT_BASE 0xd00

extern volatile BDT __at(BDT_BASE + 0x00) ep0Bo;          //Endpoint #0 BD Out
extern volatile BDT __at(BDT_BASE + 0x04) ep0Bi;          //Endpoint #0 BD In
extern volatile BDT __at(BDT_BASE + 0x08) ep1Bo;          //Endpoint #1 BD Out
extern volatile BDT __at(BDT_BASE + 0x0c) ep1Bi;          //Endpoint #1 BD In
extern volatile BDT __at(BDT_BASE + 0x10) ep2Bo;          //Endpoint #2 BD Out
...
// # of bytes from last VENDOR transaction
extern byte VENDORRxLen;
